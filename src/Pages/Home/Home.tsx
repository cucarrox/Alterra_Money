...
const PriceHighlight: React.FC<PriceHighlightProps> = ({
  ...
  return (
    <td className={`py-5 pl-8 text-center bg-gray_600 ${colorClass}`}>
      {children}
    </td>
  );
};
            ...
            {transactions.map((transaction) => {
              return (
                <tr key={transaction.id}>
                  <td
                    width="50%"
                    className="py-5 pl-8 bg-gray_600 rounded-tl-md rounded-bl-md"
                  >
                  ...
                  <td className="py-5 pl-8 bg-gray_600">
